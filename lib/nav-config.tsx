...
export const NAV_ITEMS: NavItem[] = [
  ...
  { name: 'Customer Detail', href: '/customers/[id]', icon: <UsersRound size={20} />, roles: ['MANAGER', 'STAFF', 'SUPPORT_TEAM', 'LEAD_TECH', 'TECHNICIAN'] },
  ...
  { name: 'Device Detail', href: '/devices/[id]', icon: <Database size={20} />, roles: ['MANAGER', 'STAFF', 'SUPPORT_TEAM', 'LEAD_TECH', 'TECHNICIAN'] },
  ...
  { name: 'Spare Part Detail', href: '/spare-parts/[id]', icon: <Wrench size={20} />, roles: ['MANAGER', 'STAFF'] },
  ...
  { name: 'Supplier Detail', href: '/suppliers/[id]', icon: <Store size={20} />, roles: ['MANAGER'] },
  { name: 'Supplier Edit', href: '/suppliers/[id]/edit', icon: <Store size={20} />, roles: ['MANAGER'] },
  { name: 'Contract Management', href: '/contracts', icon: <FileText size={20} />, roles: ['MANAGER', 'STAFF', 'SUPPORT_TEAM', 'CUSTOMER'] },
  { name: 'Contract Detail', href: '/contracts/[id]', icon: <FileText size={20} />, roles: ['MANAGER', 'STAFF', 'SUPPORT_TEAM'] },
  { name: 'Contract Edit', href: '/contracts/[id]/edit', icon: <FileText size={20} />, roles: ['MANAGER', 'STAFF'] },
  ...
  { name: 'My Device Detail', href: '/my-devices/[id]', icon: <Package size={20} />, roles: ['CUSTOMER'] },
  ...
  { name: 'Create User', href: '/users/create', icon: <ShieldCheck size={20} />, roles: ['ADMIN', 'SUPER_ADMIN'] },
...
export const GROUPS: Record<string, string[]> = {
  ...
  management: ['/customers', '/customers/create', '/customers/[id]', '/devices', '/devices/create', '/devices/[id]', '/spare-parts', '/spare-parts/create', '/spare-parts/[id]', '/suppliers', '/suppliers/create', '/suppliers/[id]', '/suppliers/[id]/edit', '/contracts', '/contracts/[id]', '/contracts/[id]/edit'],
  inventory: ['/inventory', '/inventory/import', '/inventory/transactions', '/inventory/dashboard'],
  customer: ['/my-devices', '/my-devices/[id]', '/service-requests'],
  admin: ['/users', '/users/customers', '/users/create'],
